...
function problemOne(dishInfo,abc){

    let results = dishInfo.filter(function(el){
        if(el.cuisine === abc){
            return true;
        }
        else{
...
let vegetarianfood = problemOne(dishes, "Vegetarian");
    console.log(vegetarianfood)

//2. Create a function that will prompt the user to enter a cuisine type and then return all dishes that match that type
//Filter

function problemTwo(abc = prompt('Please enter a type of cuisine')){

    let results = dishes.filter(function(el2){
        if(el2.cuisine === abc){
            return true;
        }
        else{
...
let numbThree = problemThree(dishes, "Vegetarian");
...
//Filter
function problemSeven(userInput=(prompt("What ingredient would you like in your food?"))){
...
let numbSeven = problemSeven();
    console.log(numbSeven)



//8a. Create a function that will return an array of the string cuisine types. Ie, ["Italian", "Italian", "Mexican", ...]
//Map
function probelmEight(){
    let justCuisines =dishes.map(function(el){
    return el.cuisine
    })
    return justCuisines
}
